...
if __name__ == "__main__":
    ...
    with open('question.txt', 'r', encoding='UTF-8') as file:
        ...
        for index, line1 in enumerate(list_question):
            ...
            module_test.Question(question, var1, var2, var3).print_question()
            answer = input()
            module_test.Answer(keys, answer).answer_of_test()
        module_test.result(list_answer)
